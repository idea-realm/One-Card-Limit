from onecardlimit import Game, Human, Computer
...
def start_game():
    start = get_user_input("Welcome to One Card Limit! Would you like to begin game? (y/n):", str, lambda x: x in ["y", "n"], "please enter 'y' or 'n'")
    if start == ValueError:
        print("Exiting...")
        return
